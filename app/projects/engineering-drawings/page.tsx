...
export const metadata: Metadata = {
  title: 'Engineering & CAD Case Study · Marrelay',
  description:
  ...
  openGraph: { title: 'Engineering & CAD Case Study · Marrelay', description: 'Shop-floor drawings that leave no room to guess.', url: '/projects/engineering-drawings' },
}
