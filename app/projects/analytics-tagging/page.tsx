...
export const metadata: Metadata = {
  title: 'Analytics & Tagging Case Study',
  description:
  ...
  openGraph: { title: 'Marrelay - Analytics & Tagging Case Study', description: 'Stop guessing. Measure what actually works.', url: '/projects/analytics-tagging' },
}
