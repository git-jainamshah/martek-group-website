...
export default function BlogsPageView({ slots }: { slots: Record<string, string> }) {
  const blogs = [
    {
  ...
  return (
    <div className="bg-background min-h-screen transition-colors duration-300">
      <PageHero
        ...
        backgroundImage={slots['blogs-banner']}
      />
